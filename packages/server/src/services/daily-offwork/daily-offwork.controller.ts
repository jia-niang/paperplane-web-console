...
import { OffworkNoticeMailSubscription, OffworkNoticeSetting } from '@repo/db'
...
export class DailyOffworkController {
  ...
  async offworkData(@Param('date') date, @Param('companyId') companyId, @Param('workplaceId') workplaceId) {
  ...
  async dateView(
    ...
    return res.render('offwork-view', await this.offwork.offworkViewData(date, companyId, workplaceId))
  }
  ...
  async addOffworkMailSubscription(@Param('settingId') settingId: string, @Body() body: OffworkNoticeMailSubscription) {
  ...
  async updateOffworkMailSubscription(@Param('subId') subId: string, @Body() body: OffworkNoticeMailSubscription) {
